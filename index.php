...
<head>
    ...
    <title>complete responsive burger website design tutorial</title>
...
<section class="home" id="home">
   ...
   <div class="content">
      ...
      <h3 data-aos="fade-up" data-aos-delay="300">Selamat Datang Di Outlet Kami</h3>
   ...
   <div class="box-container">
      ...
      <div class="box" data-aos="fade-up" data-aos-delay="150">
         ...
         <div class="content">
            ...
            <a href="order.php" class="btn" id="send">Tambahkan ke keranjang</a>
         </div>
      </div>
      ...
      <div class="box" data-aos="fade-up" data-aos-delay="300">
         ...
         <div class="content">
            ...
            <a href="order.php" class="btn">Tambahkan ke keranjang</a>
         </div>
      </div>
...
<section class="about" id="about">
   ...
   <div class="content" data-aos="fade-left" data-aos-delay="300">
      <div class="icons">
         <h3> <i class="fas fa-check"></i> Harga terbaik </h3>
         <h3> <i class="fas fa-check"></i> Layanan terbaik </h3>
         <h3> <i class="fas fa-check"></i> Bahan segar </h3>
         <h3> <i class="fas fa-check"></i> Roti alami </h3>
         <h3> <i class="fas fa-check"></i> Keju alami </h3>
         <h3> <i class="fas fa-check"></i> Sayuran & non-sayuran </h3>
      </div>
      ...
      <div class="form">
         ...
         <div class="icons-container">
            ...
            <div class="icons" data-aos="fade-up" data-aos-delay="150">
               ...
               <h3>Alamat :</h3>
               <p>kalikangkung, Jawa Tengah 54291</p> </div>

            <div class="icons" data-aos="fade-up" data-aos-delay="300">
               <i class="fas fa-envelope"></i>
               <h3>email :</h3>
               <p>alinafwatul@gmail.com</p>
               <p>burgerasik@gmail.com</p>
            </div>
...
/
   <p class="credit"> created by <span><a href="https://instagram.com/allllinnnnnn?igshid=MXhkamNtZzhvYjJz">Alin</a></span> | all rights reserved! </p><br>
